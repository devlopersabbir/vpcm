...
- chore: revert CLI version to v1.1.1 (2973e62)
...
- chore: bump version to v0.1.16 [skip ci] (f773bb5)
...
- chore: update snap build workflow to use official snapcore action and latest runner (cae776e)
- chore: bump version to v0.1.15 [skip ci] (8f71157)
- ci: update runner to ubuntu-22.04 and configure snapcraft to use destructive mode (26baea8)
- chore: bump version to v0.1.15 [skip ci] (2d77c5c)
